...
def SCBDSCV(X, y, k_splits, k_clusters, rng=None, minibatch_kmeans=False):
    if rng is None:
...
class SCBDSCVSplitter:
    ...
    def split(self, X, y=None, groups=None):
        ...
        folds, self.n_splits, self.n_clusters = SCBDSCV(
