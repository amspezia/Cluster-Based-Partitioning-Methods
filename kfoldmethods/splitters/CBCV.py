...
def CBCV(X, y, k_splits, k_clusters, rng=None, minibatch_kmeans=False):
    if rng is None:
...
class CBCVSplitter:
    def __init__(self, n_splits=None, n_clusters = None, random_state=None, shuffle=True, 
        ...
        """Split dataset indices according to the CBCV technique.
    ...
    def split(self, X, y=None, groups=None):
        ...
        folds, self.n_splits, self.n_clusters = CBCV(
